  ...
  return (
    <div className="animate-slideup">
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden', position: 'relative', minHeight: '300px' }}>
        ...
        <div className="table-responsive" style={{ opacity: showOverlay && customers.length > 0 ? 0.6 : 1, pointerEvents: showOverlay && customers.length > 0 ? 'none' : 'auto', transition: 'opacity 0.2s ease' }}>
